package com.spring_security.zoauth2_server.oauth2;
...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
    ...
    public JpaRegisteredClientRepository(RegisterRepository registerRepository) {
    	System.out.println("***JpaRegisteredClientRepository 생성자 호출***"); 
    ...
    public void save(RegisteredClient registeredClient) {
    	System.out.println("JpaRegisteredClientRepository -> save : " + registeredClient);
        registerRepository.save(toEntity(registeredClient));
    }

    @Override
    public RegisteredClient findById(String id) {
    	System.out.println("JpaRegisteredClientRepository -> findById : " + id);
        return registerRepository.findById(id).map(this::toObject).orElse(null);
    }

    @Override
    public RegisteredClient findByClientId(String clientId) {
    	System.out.println("JpaRegisteredClientRepository -> findByClientId : " + clientId);
    ...
    private RegisteredClient toObject(RegisterEntity entity) {
    	System.out.println("JpaRegisteredClientRepository -> toObject : " + entity);
    ...
    private RegisterEntity toEntity(RegisteredClient registeredClient) {
    	System.out.println("JpaRegisteredClientRepository -> toEntity : " + registeredClient);
    ...
    private Map<String, Object> parseMap(String data) {
    	System.out.println("JpaRegisteredClientRepository -> parseMap : " + data);
        try {
    ...
    private String writeMap(Map<String, Object> data) {
    	System.out.println("JpaRegisteredClientRepository -> writeMap : " + data);
        try {
    ...
    private static AuthorizationGrantType resolveAuthorizationGrantType(String authorizationGrantType) {
    	System.out.println("JpaRegisteredClientRepository -> AuthorizationGrantType  resolveAuthorizationGrantType: " + authorizationGrantType);
    ...
    private static ClientAuthenticationMethod resolveClientAuthenticationMethod(String clientAuthenticationMethod) {
    	System.out.println("JpaRegisteredClientRepository -> ClientAuthenticationMethod  resolveClientAuthenticationMethod: " + clientAuthenticationMethod);
